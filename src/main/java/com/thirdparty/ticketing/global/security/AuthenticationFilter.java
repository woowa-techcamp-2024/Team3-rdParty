...
public class AuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if(Objects.nonNull(bearerAccessToken)) {
            ...
            log.debug("[auth] JWT 인증 프로세스 종료. 사용자 인증됨. principal={}", jwtAuthentication.getPrincipal());
        }
    ...
    private JwtAuthentication authenticate(String accessToken) {
        ...
        return new JwtAuthentication(customClaims.getEmail(), customClaims.getMemberRole(), accessToken);
    }
}
