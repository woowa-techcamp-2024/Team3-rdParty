package com.thirdparty.ticketing.ticket;
...
import com.thirdparty.ticketing.jpa.seat.SeatStatus;
...
public class CacheReservationTest {
    ...
    @Autowired private LettuceSeatLockRepository lettuceRepository;
