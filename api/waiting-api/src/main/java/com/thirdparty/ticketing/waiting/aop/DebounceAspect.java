package com.thirdparty.ticketing.waiting.aop;
...
public class DebounceAspect {
    ...
    @Pointcut("@annotation(com.thirdparty.ticketing.waiting.aop.Debounce)")
    private void debounceAnnotation() {}

    @Pointcut(
            "execution(public void com.thirdparty.ticketing.waiting.waitingsystem.WaitingSystem.moveUserToRunning(long))")
